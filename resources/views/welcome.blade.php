            ...
            <div class="absolute top-2 right-2" style="z-index: 10000;">
                ...
                <div class="relative">
                    <div @click="filtersOpen = ! filtersOpen;"
                        class="border border-2 mt-2 h-9 w-9 bg-white shadow-sm rounded-md cursor-pointer flex items-center justify-center"
                        :class="{
                ...
                <div class="relative">
                    <div
                        ...
                        class="border border-2 mt-2 h-9 w-9 bg-white overflow:hidden shadow-sm rounded-md cursor-pointer flex items-center justify-center"
                        :class="{
