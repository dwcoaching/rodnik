...
@section('content')
    <div class="prose">
        ...
        <div class="mt-3 max-w-prose">
            Idea: Rodnik potentially can be used to display data from many sources.
            Each Rodnik object can have many external sources with different licenses.

            All data entered by Rodnik Today users is public domain.

            Rodnik stores current representation of an object in another system (but
            not the history of changes).

            All Data added by Rodnik used is stored as additions, not modifications.
        ...
        <div class="mt-3">
            Rodnik.today is open data, licensed under the <a href="https://www.openstreetmap.org/copyright" class="text-blue-600" target="_blank">Open Data Commons Open Database License</a>.
        </div>
        ...
        <div class="mt-3">
            <a href="https://docs.google.com/document/d/173TpVT7EQCEVaLyL3uB9dsjSwYiSzZP-jeKSuRPVwfM/edit" class="text-blue-600">Learn more about Rodnik.today</a> <i>(Google document, work in progress)</i>.
        </div>
