        ...
        <div class="border-t border-stone-200 p-4">
            <div class="flex space-x-3">
                <div class="flex-1">
                            ...
                            <div x-data>
                                <div x-menu class="relative">
                                    ...
                                    <div x-menu:items x-cloak
                                        style="display: none;"
                                        class="absolute overflow-hidden border border-stone-300 right-0 min-w-48 w-max max-w-[calc(100vw-3rem)] p-1 mt-2 z-10 origin-top-right bg-white rounded-lg shadow-lg
                    ...
                    <div class="mt-2 text-base text-black break-normal wrap-anywhere">
