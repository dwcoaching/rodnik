    ...
    <div wire:loading.remove>
        @if ($loaded)
            <div class="flex items-center">
                <div class="mr-4">
                    <a href="/about" wire:navigate class="text-blue-600 text-sm flex items-center font-normal text-sm text-blue-600 hover:text-blue-700">
            ...
            <div class="mt-3 mb-3 text-sm font-medium">
