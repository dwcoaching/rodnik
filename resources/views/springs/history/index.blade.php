    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-6 pb-20"
        ...
        <div class="flex items-center justify-between">
            <div class="flex-1 min-w-0 flex">
                <a href="{{ duo_route(['spring' => $spring->id]) }}" class="block btn btn-sm text-base font-semibold text-blue-600 hover:text-blue-700 flex items-center">
                                        ...
                                        <div class="text-sm font-semibold text-gray-600">
                                            @if ($event->user)
                                                <a class="block flex flex-wrap items-center text-sm text-blue-600 cursor-pointer hover:text-blue-700"
                                                    href="{{ duo_route(['user' => $event->user_id]) }}">
